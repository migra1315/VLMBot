...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--sam_version", type=str,
        default="vit_h",
        required=False, help="SAM ViT version: vit_b / vit_l / vit_h"
    )
    parser.add_argument(
        "--sam_checkpoint", type=str,
        default="sam_vit_h_4b8939.pth",
        required=False, help="path to sam checkpoint file"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default="outputs/color.png",
        help="path to image file")
    parser.add_argument(
        "--text_prompt", type=str,
        default="red tabe",
        help="text prompt")
    parser.add_argument(
        "--output_dir", "-o", type=str,
        default="outputs/SAM", help="output directory"
    )
