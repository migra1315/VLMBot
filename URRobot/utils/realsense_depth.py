...
if __name__ == "__main__":
    while 1:
        ...
        if key & 0xFF == ord('q') or key == 27:
            ...
            # 保存rgb图
            cv2.imwrite("/home/ju/Workspace/VLMBot/graspnet-baseline/doc/example_data/color.png",rgb)
            cv2.imwrite("/home/ju/Workspace/VLMBot/graspnet-baseline/doc/example_data/depth.png",depth)
