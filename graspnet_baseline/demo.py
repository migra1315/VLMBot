...
parser.add_argument('--checkpoint_path', default='/home/ju/Workspace/VLMBot/graspnet-baseline/logs/logs_rs/checkpoint-rs.tar',help='Model checkpoint path')
...
def get_and_process_data(data_dir):
    ...
    print(workspace_mask_uint8.shape)
...
def vis_grasps(gg, cloud,num_top_grasps=50):
    ...
    return gg.translations, gg.rotation_matrices
...
if __name__=='__main__':
    data_dir = '/home/ju/Workspace/VLMBot'
    demo(data_dir)
